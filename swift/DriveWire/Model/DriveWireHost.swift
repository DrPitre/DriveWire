...
private final class StandardMIDIFileStreamPlayback {
...
public class DriveWireHost : Codable {
    ...
    private static let midiVirtualSerialChannel: UInt8 = 14
    private static let standardMIDIFileSignature = Data([0x4D, 0x54, 0x68, 0x64])
    ...
    private func refreshMIDIStatus() {
    ...
    public private(set) var midiMonitorStatus = DriveWireMIDIStatus()
    ...
    private var lastMIDIErrorMessage: String?
    private var midiState = "Idle"
    private var midiBytesReceived = 0
    private var midiFileBytesReceived = 0
    private var midiMessagesSent = 0
    private var midiStreamMode = MIDIStreamMode.undetermined
    private var midiBufferedData = Data()
    private var standardMIDIPlayback: StandardMIDIFileStreamPlayback?

    private enum MIDIStreamMode {
        case undetermined
        case raw
        case standardFile
    }
...
//            throw DriveWireHostError.driveAlreadyExists
    ...
    private func serialMultiByteCount(_ countByte: UInt8) -> Int {
    ...
    private func handleMIDIData(_ data: Data) {
    ...
    private func resetMIDIStreamState() {
    ...
    private func isMIDIVirtualSerialChannel(_ channel: UInt8) -> Bool {
